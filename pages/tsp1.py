...
for i in range(1, 11):
    ...
    x_coord = col2.number_input(f"x-coordinate (City {i})", min_value=0, max_value=0, key=f"x_coord_{i}")
    y_coord = col3.number_input(f"y-coordinate (City {i})", min_value=0, max_value=0, key=f"y_coord_{i}")
